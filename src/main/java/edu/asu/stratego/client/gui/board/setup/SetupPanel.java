...
public class SetupPanel {
    ...
    private UpdateReadyButtonInterface updateReadyButton;

    /**
     * Creates a new instance of SetupPanel.
     */
    public SetupPanel(SetupTimerInterface timer,SelectPieceInterface selectPiece) {
        ...
        // Panel background.
        String backgroundURL = "/images/board/setup_panel.png";
        ...
        //SetupTimerInterface timer = new SetupTimer();
        timer.startTimer();
        ...
        SetupPieces pieces = new SetupPieces(selectPiece);
        ...
        readyButton.addEventHandler(MouseEvent.MOUSE_ENTERED_TARGET, _ -> {
            readyButton.setImage(ImageConstants.READY_HOVER);
        });
        
        readyButton.addEventHandler(MouseEvent.MOUSE_EXITED_TARGET, _ -> {
            readyButton.setImage(ImageConstants.READY_IDLE);
        });
        
        readyButton.addEventHandler(MouseEvent.MOUSE_CLICKED, _ -> {
        ...
        // have been placed.
        updateReadyButton = new UpdateReadyButton(updateReadyStatus, 
                                                   instructionPane, instructions, readyButton);
        Thread updateButton = new Thread(updateReadyButton);
     ...
     * @see edu.asu.stratego.client.gui.board.setup.SetupPieces
     * @see edu.asu.stratego.client.gui.board.setup.UpdateReadyButton
     */
    ...
    public static void finishSetup() {
        Object setupPieces = GameUIManager.getSetupPieces();
