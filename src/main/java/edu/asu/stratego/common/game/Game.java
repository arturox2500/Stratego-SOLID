...
import edu.asu.stratego.common.game.board.ClientBoard;

/**
 * Contains information about the Stratego game, which is shared between the 
 * JavaFX GUI and the ClientGameInterface.
 * 
 * @see edu.asu.stratego.client.gui.ClientStage
 * @see edu.asu.stratego.client.clientGameManager.clientGameManager.ClientGameInterface
 */
public class Game {
