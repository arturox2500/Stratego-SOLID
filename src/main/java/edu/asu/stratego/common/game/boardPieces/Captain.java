...
public class Captain implements PieceTypeInterface, Serializable {
    @Override public int getValue() { return 6; }
    @Override public int getCount() { return 4; }
    @Override public String getName() { return "Captain"; }
    ...
    public String getSpriteKey(PieceColor color, boolean isOpponentPiece) {
        ...
        return color == PieceColor.RED ? "RED_06" : "BLUE_06";
    }
