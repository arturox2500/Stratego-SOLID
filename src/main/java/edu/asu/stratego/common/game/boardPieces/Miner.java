...
public class Miner implements PieceTypeInterface, Serializable {
    ...
    public BattleOutcome attack(PieceTypeInterface defender) {
        ...
        if (defender instanceof Bomb) return BattleOutcome.WIN;
    ...
    public String getSpriteKey(PieceColor color, boolean isOpponentPiece) {
        ...
        return color == PieceColor.RED ? "RED_03" : "BLUE_03";
    }
